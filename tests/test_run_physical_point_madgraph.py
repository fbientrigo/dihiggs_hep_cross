...
@pytest.mark.skipif(
    os.environ.get("DIHIGGS_RUN_EXTERNAL_MG") != "1" or not DEFAULT_PROC_DIR.exists(),
    reason="set DIHIGGS_RUN_EXTERNAL_MG=1 with a compiled MadGraph process to run the external closure",
)
def test_benchmark_closure_execution(tmp_path):
    point = {
        ...
        "ctau_physical_mm": 4.326221529733112,
        "ctau_response_mm": 4.326221529733112,
