...
################Form Factor defined for GG->h into "long-lived particles model"#############################################################            
VVS2FF1 = Lorentz(name = 'VVS2FF1',
               spins = [ 3, 3, 1 ],
               structure = 'GGHFF*(P(1,2)*P(2,1) - P(-1,1)*P(-1,2)*Metric(1,2))',
               formfactors=[ForFac.GGHFF])
###########################################################################################################################################               
