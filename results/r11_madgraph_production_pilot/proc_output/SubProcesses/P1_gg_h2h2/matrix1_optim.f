...
C     
C     Process: g g > h > h2 h2 WEIGHTED<=2 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WH)
        IF(mdl_Wh2.ne.0d0) fk_mdl_Wh2 = SIGN(MAX(ABS(mdl_Wh2),
     $    ABS(mdl_Mh2*small_width_treatment)), mdl_Wh2)
      endif
      AMP(:,:) = (0d0,0d0)
      ...
      CALL SXXXXX(P(0,4),+1*IC(4),W(1,6))  !  count 2
      CALL VVS2FF1_3(W(1,1),W(1,3),GC_15,MDL_MH,FK_MDL_WH,W(1,7))  !  count 1
      CALL VVS2FF1_3(W(1,2),W(1,4),GC_15,MDL_MH,FK_MDL_WH,W(1,8))  !  count 1
      CALL SSS1P1N_1(W(1,5), W(1,6), GC_90, TMP(1))
      call CombineAmpS(2, 
     &(/2,1/), 
     & (/7,8/), 
