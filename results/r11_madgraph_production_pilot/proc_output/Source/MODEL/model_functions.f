...
C       segments from -DABS(tiny*Ga) to Ga
     ...
     $   +ADDFACTOR(4))
        ...
        DOUBLE COMPLEX FUNCTION FUNCFB(BETA)
        IMPLICIT NONE
        DOUBLE COMPLEX BETA
        DOUBLE COMPLEX CONDIF
        FUNCFB = CONDIF((DBLE(BETA).LT.1.000000D+00),DCMPLX((
     $   -1.000000D+00/(4.000000D+00))*(LOG((SQRT(DCMPLX(1.000000D+00
     $   -DBLE(BETA)))+1.000000D+00)/(1.000000D+00
     $   -SQRT(DCMPLX(1.000000D+00-DBLE(BETA))))-DCMPLX(0D0, 1.000000D
     $   +00)*3.141593D+00)**2)),DCMPLX(ASIN(1.000000D+00
     $   /SQRT(DCMPLX(DBLE(BETA))))**2))

        RETURN
        END


        DOUBLE COMPLEX FUNCTION C0_FUNCTION(SS, TAU)
        IMPLICIT NONE
        DOUBLE COMPLEX SS, TAU
        DOUBLE COMPLEX CONDIF
        C0_FUNCTION = CONDIF((DBLE(TAU).GE.1.000000D+00.AND.DBLE(SS)
     $   .GT.0.000000D+00),DCMPLX((1.000000D+00/(2.000000D+00*SS)
     $   *(LOG((SQRT(DCMPLX(1.000000D+00-(1.000000D+00/TAU)))
     $   +1.000000D+00)/(1.000000D+00-SQRT(DCMPLX(1.000000D+00
     $   -(1.000000D+00/TAU)))))-DCMPLX(0D0, 1.000000D+00)*3.141593D
     $   +00)**2)),DCMPLX((-(2.000000D+00/SS)*ASIN(SQRT(DCMPLX(TAU)))*
     $   *2)))
        ...
        DOUBLE COMPLEX FUNCTION REGFUNCTION(SS)
        IMPLICIT NONE
        DOUBLE COMPLEX SS
        DOUBLE COMPLEX CONDIF
        REGFUNCTION = CONDIF(DBLE(SS).EQ.0.000000D+00,DCMPLX(1.000000D
     $   -11),DCMPLX(SS))
        ...
        DOUBLE COMPLEX FUNCTION FUNCFF(BETA)
        IMPLICIT NONE
        DOUBLE COMPLEX BETA
        DOUBLE COMPLEX CONDIF
        FUNCFF = CONDIF((DBLE(BETA).LT.1.000000D+00),DCMPLX(-2.000000D
     $   +00*DBLE(BETA)*(1.000000D+00+(1.000000D+00-DBLE(BETA))*(
     $   -1.000000D+00/(4.000000D+00))*(LOG((SQRT(DCMPLX(1.000000D+00
     $   -DBLE(BETA)))+1.000000D+00)/(1.000000D+00
     $   -SQRT(DCMPLX(1.000000D+00-DBLE(BETA))))-DCMPLX(0D0, 1.000000D
     $   +00)*3.141593D+00)**2))),DCMPLX(-2.000000D+00*DBLE(BETA)
     $   *(1.000000D+00+(1.000000D+00-DBLE(BETA))*ASIN(1.000000D+00
     $   /SQRT(DCMPLX(DBLE(BETA))))**2)))
        ...
        DOUBLE COMPLEX FUNCTION FUNCFW(BETA)
        IMPLICIT NONE
        DOUBLE COMPLEX BETA
        DOUBLE COMPLEX CONDIF
        FUNCFW = CONDIF((DBLE(BETA).LT.1.000000D+00),DCMPLX(2.000000D
     $   +00+3.000000D+00*DBLE(BETA)+3.000000D+00*DBLE(BETA)
     $   *(2.000000D+00-DBLE(BETA))*(-1.000000D+00/(4.000000D+00))
     $   *(LOG((SQRT(DCMPLX(1.000000D+00-DBLE(BETA)))+1.000000D+00)
     $   /(1.000000D+00-SQRT(DCMPLX(1.000000D+00-DBLE(BETA))))
     $   -DCMPLX(0D0, 1.000000D+00)*3.141593D+00)**2))
     $   ,DCMPLX(2.000000D+00+3.000000D+00*DBLE(BETA)+3.000000D+00
     $   *DBLE(BETA)*(2.000000D+00-DBLE(BETA))*ASIN(1.000000D+00
     $   /SQRT(DCMPLX(DBLE(BETA))))**2))
